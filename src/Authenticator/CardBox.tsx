...
import { ListSubheader, Grid, LinearProgress } from 'material-ui';
...
class CardBox extends React.Component<WithStyles & CardBox.Props> {
    ...
    constructor(props?: (WithStyles & CardBox.Props), context?: any) {
...
export default withStyles(styles, { withTheme: true })<CardBox.Props>(CardBox);